...
public class OrderService implements IOrderService{
    ...
    public Order updateOrder(Long id, OrderDTO orderDTO)
        ...
        modelMapper.typeMap(OrderDTO.class, Order.class)
                .addMappings(mapper -> {
                    ...
                    mapper.skip(Order::setOrderDate); // Bỏ qua việc cập nhật order_date
                });
    ...
    @Override
    public Page<Order> getOrdersByUserIdAndKeyword (Long userId, String keyword,Pageable pageable){
        return  orderRepository.getOrdersByUserIdAndKeywird(userId,keyword,pageable);
    }
}
