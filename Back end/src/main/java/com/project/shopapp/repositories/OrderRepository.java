...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT o FROM Order o WHERE o.active = true " +
            "AND o.user = :user_id  " +  // Đảm bảo id là bắt buộc
    ...
    Page<Order> getOrdersByUserIdAndKeywird(@Param("user_id") Long useId,@Param("keyword") String keyword,Pageable pageable);
